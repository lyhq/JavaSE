...
public class DynamicProxyTest {
	...
	public static void main(String[] args) {
		...
		//5、把静态代理的被代理类也拿过来实现下
		//1)创建一个被代理类的对象
		shk.lyhq.design.patterns.Proxy.Static.Source subject 
				= new shk.lyhq.design.patterns.Proxy.Static.Source();
		//2)对subject实例化，并返回一个同样 实现了被代理类所实现的接口 的代理类对象
		Object object = invocationHandler.bind(subject);
		shk.lyhq.design.patterns.Proxy.Static.Sourceable proxySource 
				= (shk.lyhq.design.patterns.Proxy.Static.Sourceable) object;//这个就是代理类对象
